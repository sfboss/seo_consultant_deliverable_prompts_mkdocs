# Competitive Positioning Report — Buccifirm.com
...
## Prompt Executed
```text
Produce a competitive positioning report comparing [WEBSITE_URL] vs [COMPETITOR_URLS] by topic visibility, share-of-voice trends, and strategic opportunities.
```
