# Featured Snippet Optimization — Buccifirm.com
...
## Prompt Executed
```text
Identify snippet opportunities for [WEBSITE_URL] and recommend formatting patterns (definitions, lists, tables, Q&A blocks) per keyword cluster.
```
